...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/clustermanager/egressservice_cluster"
...
type FakeClusterManager struct {
	...
	esvc         *egressservice_cluster.Controller
...
func (o *FakeClusterManager) init() {
	...
	if config.OVNKubernetesFeature.EnableEgressService {
		o.esvc, err = egressservice_cluster.NewController(o.fakeClient, o.watcher, isReachable)
		gomega.Expect(err).NotTo(gomega.HaveOccurred())
