...
func (k *Kube) SetLabelsOnNode(nodeName string, labels map[string]interface{}) error {
	...
	_, err = k.KClient.CoreV1().Nodes().Patch(context.TODO(), nodeName, types.MergePatchType, patchData, metav1.PatchOptions{}, "status")
	return err
}
...
// UpdatePodStatus update pod with provided pod data
